...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate paper reader agent performance"
    )
    parser.add_argument(
        "--test_data", type=str, required=True, help="Path to test data JSON file"
    )
    parser.add_argument(
        "--index_name",
        type=str,
    ...
    evaluator = ModelEvaluator(query_function=query_function, test_dataset=test_data)
